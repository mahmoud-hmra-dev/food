...
<body>
  <style>
    ...
    <div class="main-wrapper">
        <div   class="ct-banner-image primary-navbar hls" style="background: url(<?php echo get_home_page_img();?>)">
        <div class="navbar-wrapper">
            <!--Food Court Navbar Section-->
            <nav style=" backdrop-filter: blur(10px); background-color: #ffffff1c;" class="navbar navbar-static-top ct-navbar-statictop fc-nav-bar">
                <div class="container">
                    <div class="row">
                        <div class="ct-logo">
