					...
					?>
                                ...
                                <div class="col-md-6">
									...
									<img id="second_site_logoo" src="<?php echo $src;?>" style="<?php echo $style;?>" alt="Secondary Site Logo"> 
									  ...
									  <div class="form-group">
                                        <label><?php echo get_languageword('home_page_image').required_symbol();?>(<small><strong><?php echo ALLOWED_TYPES;?></strong> </small>) <small>(min & max height*width:1920*1080)</small> </label>
